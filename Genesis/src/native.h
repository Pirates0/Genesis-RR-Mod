...
namespace native {
        ...
        namespace Collections {
            namespace Generic {
                struct List : Il2CppObject {
                    typedef int(*_tget_Count)(List* __this, const MethodInfo* method_info);
                    inline static _tget_Count get_Count;

                    typedef Il2CppObject*(*_tget_Item)(List* __this, int index, const MethodInfo* method_info);
    ...
    namespace UnityEngine {
        ...
        struct Quaternion {
            ...
            typedef void(*_tset_eulerAngles)(Il2CppObject* __this, Vector3 value, const MethodInfo* method_info);
	...
	//	public bool EquipOutfitItem(AvatarItem item, Player.BodyPart bodyPart, PlayerAvatar.AvatarItemHandEquipType handEquipType, bool allowTrialItems); // RVA: 0x1807DB210 Offset: 0x7DA610


		typedef bool(*_tIsWearingAnyTrialItems)(PlayerAvatar* __this, MethodInfo* mi);
		inline static _tIsWearingAnyTrialItems IsWearingAnyTrialItems;
		...
		namespace Avatar {
			...
			namespace Outfit {
				...
				struct PlayerOutfit {
					...
					typedef bool (*_tAddOutfitItem)(PlayerOutfit* __this, Il2CppString* outfit, MethodInfo* mi);
					inline static _tAddOutfitItem AddOutfitItem;
    ...
    struct GameCombatManager : Il2CppObject {
		...
		typedef void (*_tUpdate)(GameCombatManager* __this, MethodInfo* mi);
		inline static _tUpdate Update;

			//private void Update(); // RVA: 0x1808857E0 Offset: 0x884BE0
		
			
			
		typedef void (*_tMasterKillPlayer)(GameCombatManager* __this, PhotonPlayer* player, MethodInfo* mi);
		
		inline static _tMasterKillPlayer MasterKillPlayer;
