...
constexpr size_t OFFSET_PLAYERAVATAR_EQUIPOUTFITITEMINTERNAL = _OFFSET(0x180EA7410);
...
constexpr size_t OFFSET_GAMECOMBATMANAGER_MASTERKILLPLAYER = _OFFSET(0x18087A080); //	public void MasterDamagePlayer(PhotonPlayer player, int damage, bool ignoreShield, out GameCombatManager.PlayerDamageResult damageResult, out GameCombatManager.PlayerShieldEffect shieldEffect); // RVA:
...
constexpr size_t OFFSET_RECROOM_CORE_AI_ENEMYMANAGER_GET_ALLENEMIES = _OFFSET(0x18113E870);

constexpr size_t OFFSET_RECROOM_CORE_AI_ENEMY_MASTERKILL = _OFFSET(0x180EBA9E0);
...
constexpr size_t OFFSET_RECROOM_CORE_ENCOUNTERS_SPAWNENEMYENCOUNTERSTEP_SET_ENEMYSPAWNCOUNT = _OFFSET(0x180D02660);

constexpr size_t OFFSET_RECROOM_CORE_CREATION_CREATIONMANAGER_GET_ACTIVESANDBOXRESOURCECOST = _OFFSET(0x180F3DA70);
